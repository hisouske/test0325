...
public class AuthProvider implements AuthenticationProvider{
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        String webpw= (String)authentication.getCredentials();
    
        User user = userService.login(memid,webpw);

        List<GrantedAuthority> grantedAuthorityList = new ArrayList<GrantedAuthority>();
        grantedAuthorityList.add(new SimpleGrantedAuthority(user.getAuthority()));

        System.out.println(new UsernamePasswordAuthenticationToken(memid, webpw,grantedAuthorityList));
  return new UsernamePasswordAuthenticationToken(memid, webpw,grantedAuthorityList);
}
