...
public class User implements UserDetails{
    ...
    String password,int publiccode,String memcourse, String emailadd,String authority){
        // this.id = id;
    ...
    public String toString(){
        return String.format("User[username="+username+",password="+password+",memcourse="+memcourse+",emailadd="+emailadd+",authority="+Authority+"]");
    }
