...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter /** WebSecurityConfig instence 생성 하기 위한 클래스 **/{
	...
	@Override
	protected void configure(final HttpSecurity http)/** HTTP 요청에 대한 웹 기반 보안 구성 */ throws Exception {
		http
	...
	//회원가입시 필요 
	@Autowired
public void configAuthentication(final AuthenticationManagerBuilder auth, final DataSource dataSource) throws Exception { //모든 인증 Manager
